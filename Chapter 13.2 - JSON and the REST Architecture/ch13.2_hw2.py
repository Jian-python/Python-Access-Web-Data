...
while True:
    ...
    print('Place id:', info[0]['place_id'])


'''results:
# Enter location: South Federal University
# Retrieving http://python-data.dr-chuck.net/geojson?address=South+Federal+University
# Retrieved 2101 characters
# Place id: ChIJJ8oO7_B_bIcR2AlhC8nKlok
# Enter location: Portland State University
# Retrieving http://python-data.dr-chuck.net/geojson?address=Portland+State+University
# Retrieved 2340 characters
# Place id: ChIJxawmfxcKlVQRtAXXc-blqv0
# Enter location: 
'''
